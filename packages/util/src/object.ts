import {isArr, isFunc, isNil, isObj, isUndef} from './normal';
import {lowercase} from './string';

import type {AO, GF} from '@dye/types';
...
export const attrOf = (obj: AO, of: undefined | string | GF): any => {
